   ...
   public  class UserService : IUserService
    {
        ...
        public IEnumerable<AspNetUser> GetAllLandLords()
        {
            var results = this._dataService.GetAspNetUsers();
            List<EF.Models.AspNetUser> landLords = new List<EF.Models.AspNetUser>();
            if (results.Any())
            {
                foreach (var result in results)
                {
                    ...
                    {
                        landLords.Add(result);
                    }

                }
                return MapEFToModel(landLords);
            }
            return null;
